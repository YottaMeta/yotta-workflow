...
源码目录可以等于项目根，也可以嵌套在项目根里；唯一区别是：**源码目录是否放 `.workflow`，只看它是否被明确指定为项目根，不看它是不是 Git 仓库。**
...
| 场景 | 项目根 | 源码目录 | 状态目录 |
| --- | --- | --- | --- |
| 用户说“当前目录就是项目根”，且它是单仓库 | `D:\work\my-app` | `D:\work\my-app` | `D:\work\my-app\.workflow\` |
| 用户指定项目根为上层 | `D:\work\my-project` | `D:\work\my-project\app` | `D:\work\my-project\.workflow\` |
